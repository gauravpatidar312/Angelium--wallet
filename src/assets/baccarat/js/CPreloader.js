function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "assets/baccarat/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "assets/baccarat/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "assets/baccarat/sprites/but_start.png");
