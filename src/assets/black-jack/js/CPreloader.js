function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "assets/black-jack/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "assets/black-jack/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "assets/black-jack/sprites/but_start.png");
