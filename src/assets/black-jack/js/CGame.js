        ...
        if(_iCardIndexToDeal<_aCurActiveCardOffset.length*2){
                ...
                if((_iCardIndexToDeal%_aCurActiveCardOffset.length) === 1){
                    ...
                    if(!_bDealerLoseInCurHand && _iNextCardForPlayer === 1 
                                            &&(s_oGameSettings.getCardValue(_aCardsInCurHandForPlayer[_iNextCardForPlayer])+s_oGameSettings.getCardValue(_aCardsInCurHandForPlayer[_iNextCardForPlayer-1]) ) === 21){
