...
export class HeavenChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  ...
  ngOnChanges(): void {
    if (this.echartsIntance) {
      this.updateHeavenChartOptions(this.heavenChartData);
    }
  }
  ...
  setOptions(eTheme) {
    this.options = {
      ...
      xAxis: [
        {
          type: 'category',
          data: this.heavenChartData.chartLabel,
          axisTick: {
            alignWithLabel: true,
          },
          axisLine: {
      ...
      series: [
        {
          ...
          data: this.heavenChartData.data[0],
        },
        {
          name: 'Payment',
          type: 'bar',
          ...
          data: this.heavenChartData.data[1],
        },
        {
          name: 'All orders',
          type: 'bar',
          ...
          data: this.heavenChartData.data[2],
        },
      ],
    };
  }

  updateHeavenChartOptions(heavenChartData: HeavenChart) {
    const options = this.options;
    const series = this.getNewSeries(options.series, heavenChartData.data);
