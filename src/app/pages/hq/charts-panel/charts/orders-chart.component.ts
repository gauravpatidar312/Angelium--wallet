  ...
  setOptions(eTheme) {
    this.option = {
      ...
      series: [
        ...
        this.getSixthLine(eTheme),
        this.getSeventhLine(eTheme)
      ],
    };
  }
    ...
    return {
      ...
      areaStyle: {
        normal: {
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
            offset: 0,
            color: eTheme.fifthLineGradFrom,
          }, {
            offset: 1,
            color: eTheme.fifthLineGradTo,
          }]),
          opacity: 1,
        },
      },
    ...
    return {
      ...
      areaStyle: {
        normal: {
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
            offset: 0,
            color: eTheme.seventhLineGradFrom,
          }, {
            offset: 1,
            color: eTheme.seventhLineGradTo,
          }]),
          opacity: 1,
        },
      },
