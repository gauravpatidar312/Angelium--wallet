...
export class RewardChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  ...
  ngOnChanges(): void {
    if (this.option) {
      this.updateRewardsChartOptions(this.rewardsChartData);
    }
  }
  ...
  updateRewardsChartOptions(RewardsChartData: RewardsChart) {
    const options = this.option;
    const series = this.getNewSeries(options.series, RewardsChartData.linesData);
    const xAxis = this.getNewXAxis(options.xAxis, RewardsChartData.chartLabel);
