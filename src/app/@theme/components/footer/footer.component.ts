...
@Component({
  ...
  template: `
    <span class="created-by font-nunitoSans">{{"footer.allRightsReservedBy" | translate}} <span><a href="https://angelium.net" class="angelium-text" target="_blank">ANGELIUM</a></span></span>
    <div class="socials">
