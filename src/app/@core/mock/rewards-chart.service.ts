...
@Injectable()
export class RewardChartService extends RewardsChartData {
  ...
  private getDataForWeekPeriod(): RewardsChart {
    return {
  ...
  private getDataForMonthPeriod(): RewardsChart {
    return {
  ...
  private getDataForYearPeriod(): RewardsChart {
    return {
  ...
  getRewardsChartData(period: string): RewardsChart {
